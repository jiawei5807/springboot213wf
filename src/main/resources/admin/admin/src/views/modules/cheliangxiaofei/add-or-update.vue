<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="车牌号码" prop="chepaihaoma">
          <el-select :disabled="ro.chepaihaoma" @change="chepaihaomaChange" v-model="ruleForm.chepaihaoma" placeholder="请选择车牌号码">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.chepaihaoma" label="车牌号码" prop="chepaihaoma">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="人工费合计" prop="rengongfeiheji">
          <el-input v-model="ruleForm.rengongfeiheji"
              placeholder="人工费合计" clearable  :readonly="ro.rengongfeiheji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="人工费合计" prop="rengongfeiheji">
              <el-input v-model="ruleForm.rengongfeiheji"
                placeholder="人工费合计" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="材料费合计" prop="cailiaofeiheji">
          <el-input v-model="ruleForm.cailiaofeiheji"
              placeholder="材料费合计" clearable  :readonly="ro.cailiaofeiheji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="材料费合计" prop="cailiaofeiheji">
              <el-input v-model="ruleForm.cailiaofeiheji"
                placeholder="材料费合计" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="实收金额" prop="shishoujine">
          <el-input v-model="ruleForm.shishoujine"
              placeholder="实收金额" clearable  :readonly="ro.shishoujine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="实收金额" prop="shishoujine">
              <el-input v-model="ruleForm.shishoujine"
...
export default {
  data() {
	...
	chepaihaoma : false,
	zhanghao : false,
	rengongfeiheji : false,
	cailiaofeiheji : false,
	zongjine : false,
	shishoujine : false,
	ispay : false,
      },
  ...
  computed: {
    zongjine: {
      get: function () {
        return 0+parseFloat(this.ruleForm.rengongfeiheji==""?0:this.ruleForm.rengongfeiheji)+parseFloat(this.ruleForm.cailiaofeiheji==""?0:this.ruleForm.cailiaofeiheji) || 0
      }
    },
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhanghao = true;
          ...
          if(o=='rengongfeiheji'){
            this.ruleForm.rengongfeiheji = obj[o];
	    this.ro.rengongfeiheji = true;
            continue;
          }
          if(o=='cailiaofeiheji'){
            this.ruleForm.cailiaofeiheji = obj[o];
	    this.ro.cailiaofeiheji = true;
            continue;
          }
          if(o=='zongjine'){
    ...
    chepaihaomaChange () {
      this.$http({
        url: `follow/cheliangxinxi/chepaihaoma?columnValue=`+ this.ruleForm.chepaihaoma,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					 ...
					 this.$http({
					   url: `cheliangxiaofei/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.cheliangxiaofeiCrossAddOrUpdateFlag = false;
						 this.parent.search();
