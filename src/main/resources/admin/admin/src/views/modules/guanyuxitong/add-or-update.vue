    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="网站功能" prop="wangzhangongneng">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="网站功能"
                  v-model="ruleForm.wangzhangongneng" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.wangzhangongneng" label="网站功能" prop="wangzhangongneng">
                    <span>{{ruleForm.wangzhangongneng}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="功能介绍" prop="gongnengjieshao">
                <editor
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.gongnengjieshao" label="功能介绍" prop="gongnengjieshao">
                    <span v-html="ruleForm.gongnengjieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.biaoti = true;
          ...
          if(o=='wangzhangongneng'){
            this.ruleForm.wangzhangongneng = obj[o];
	    this.ro.wangzhangongneng = true;
            continue;
          }
          if(o=='lianxifangshi'){
	...
	this.ruleForm.gongnengjieshao = this.ruleForm.gongnengjieshao.replace(reg,'../../../springboot213wf/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					 ...
					 this.$http({
					   url: `guanyuxitong/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.guanyuxitongCrossAddOrUpdateFlag = false;
						 this.parent.search();
