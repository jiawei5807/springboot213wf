  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type=='info'"  label="历史消费" prop="lishixiaofei">
            <el-input v-model="ruleForm.lishixiaofei"
                      placeholder="历史消费" clearable  :readonly="ro.lishixiaofei"></el-input>
          </el-form-item>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					 ...
					 this.$http({
					   url: `laichedengji/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.laichedengjiCrossAddOrUpdateFlag = false;
						 this.parent.search();
