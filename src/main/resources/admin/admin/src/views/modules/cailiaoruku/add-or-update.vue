<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="材料号" prop="cailiaohao">
          <el-input v-model="ruleForm.cailiaohao"
              placeholder="材料号" clearable  :readonly="ro.cailiaohao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="材料号" prop="cailiaohao">
              <el-input v-model="ruleForm.cailiaohao"
                placeholder="材料号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="进货日期" prop="jinhuoriqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jinhuoriqi" label="进货日期" prop="jinhuoriqi">
              <el-input v-model="ruleForm.jinhuoriqi"
                placeholder="进货日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="供应商号" prop="gongyingshanghao">
          <el-input v-model="ruleForm.gongyingshanghao"
              placeholder="供应商号" clearable  :readonly="ro.gongyingshanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="供应商号" prop="gongyingshanghao">
              <el-input v-model="ruleForm.gongyingshanghao"
...
export default {
  data() {
	...
	beizhu : false,
      ...
      rules: {
          cailiaohao: [
                { required: true, message: '材料号不能为空', trigger: 'blur' },
          ],
          cailiaomingcheng: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='cailiaohao'){
            this.ruleForm.cailiaohao = obj[o];
	    this.ro.cailiaohao = true;
            continue;
          }
