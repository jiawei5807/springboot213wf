<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="接车部门" prop="jiechebumen">
          <el-input v-model="ruleForm.jiechebumen"
              placeholder="接车部门" clearable  :readonly="ro.jiechebumen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="接车部门" prop="jiechebumen">
              <el-input v-model="ruleForm.jiechebumen"
                placeholder="接车部门" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="美容项目" prop="meirongxiangmu">
          <el-input v-model="ruleForm.meirongxiangmu"
              placeholder="美容项目" clearable  :readonly="ro.meirongxiangmu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="美容项目" prop="meirongxiangmu">
              <el-input v-model="ruleForm.meirongxiangmu"
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chepaihaoma = true;
          ...
          if(o=='jiechebumen'){
            this.ruleForm.jiechebumen = obj[o];
	    this.ro.jiechebumen = true;
            continue;
          }
          if(o=='meirongxiangmu'){
            this.ruleForm.meirongxiangmu = obj[o];
	    this.ro.meirongxiangmu = true;
            continue;
          }
          if(o=='jiage'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					 ...
					 this.$http({
					   url: `cheliangmeirong/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.cheliangmeirongCrossAddOrUpdateFlag = false;
						 this.parent.search();
